...
![Navbar with Recipes tab selected](docs/navbar-recipes.png)

And press on the button with the plus sign to add a recipe:

![Add Recipe button](docs/add-recipe.png)
...
![Add recipe tab](docs/add-recipe-tab.png)
...
![Navbar with Menu tab selected](docs/navbar-menu.png)
